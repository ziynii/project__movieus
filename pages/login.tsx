      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <form className="mt-6 flex w-full flex-col">
          ...
          <div className="flex mt-2">
            ...
            />
            <button className="ml-2 h-12 w-20 rounded flex items-center justify-center bg-white text-indigo-500">
              <svg
                className="h-6 w-6"
                fill="none"
                stroke="currentColor"
        ...
        <form className="mt-4 flex w-full flex-col items-center">
          ...
          <button className="mt-8 h-14 w-48 rounded-full bg-indigo-500">
            로그인
          </button>
        </form>
